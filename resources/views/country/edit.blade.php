                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{route('country.update',$country->id)}}">
                            ...
                            <div class="form-group row">
                                <label class="col-form-label col-lg-3" for="country_code">country_code:</label>
                                <div class="col-lg-9">
                                    <input type="text" name="country_code" id="country_code" class="form-control" value="{{$country->country_code}}">
                                </div>
                            </div>
