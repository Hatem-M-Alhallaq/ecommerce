            ...
            <table class="table table-togglable table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            @if($language->status)
                            <span class="badge bg-success">{{$language->activity_status}}</span>
                            @else
                            <span class="badge badge-danger">{{$language->activity_status}}</span>
                            @endif
                        </td>
                        <td>
                            <div class="btn-group">
                                <a href="{{route('language.edit',$language->id)}}" class="badge btn-info">
                                    Edit </a>
