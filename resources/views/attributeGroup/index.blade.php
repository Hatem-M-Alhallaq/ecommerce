        ...
        <div class="card">
            <div class="card-header header-elements-inline">
                ...
                <div class="header-elements">
                    <a href="{{route('attributeGroup.create')}}" class="btn btn-success">
                        Create
                    </a>
                </div>
            </div>
            <table class="table table-togglable table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            @if($group->status)
                            <span class="badge bg-success">{{$group->activity_status}}</span>
                            @else
                            <span class="badge badge-danger">{{$group->activity_status}}</span>
                            @endif
                        </td>
                        <td>
                            <div class="btn-group">
                                <a href="{{route('attributeGroup.edit',$group->id)}}" class="badge btn-info">
                                    Edit </a>
                                <a href="#" onclick="performDestroy({{$group->id}}, this)" class="badge badge-danger">
                                    Delete </a>
                            </div>
                        </td>
                    </tr>
