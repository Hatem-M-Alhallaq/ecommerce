            ...
            <table class="table table-togglable table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            @if($city->status)
                            <span class="badge bg-success">{{$city->activity_status}}</span>
                            @else
                            <span class="badge badge-danger">{{$city->activity_status}}</span>
                            @endif
                        </td>
                        <td>
                            <div class="btn-group">
                                <a href="{{route('city.edit',$city->id)}}" class="badge btn-info">
                                    Edit </a>
                                <a href="#" onclick="performDestroy({{$city->id}}, this)" class="badge badge-danger">
                                    Delete </a>
