            ...
            <table class="table table-togglable table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td> @if(!empty($attribute->attributeGroup)) {{$attribute->attributeGroup->name}} @endif</td>

                        <td>
                            <div class="btn-group">
                                <a href="{{route('attribute.edit',$attribute->id)}}" class="badge btn-info">
                                    Edit </a>
                                <a href="#" onclick="performDestroy({{$attribute->id}}, this)"
