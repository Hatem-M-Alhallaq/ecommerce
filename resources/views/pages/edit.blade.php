                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    <label class="col-form-label col-lg-2" for="name">Pages Name</label>
                                    <div class="col-lg-10">
                                        <input type="text" name="name" id="name" value="{{$pages->name}}" class="form-control">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-10">
                                         <textarea rows="3" name="details" id="details" cols="3" class="form-control"
                                                   placeholder="Enter details here" value="{{$pages->details}}"></textarea>
                                    </div>
                                </div>

                                <div class="form-group row">
                                    <label class="col-form-label col-lg-2" for="image">Pages Image</label>
                                    <div class="col-lg-10">
                                        <input type="file" name="image" id="image" value="{{$pages->image}}" class="form-control">
                                    </div>
                                </div>
                                    ...
                                    <div class="card-body">
                                        <div class="form-group">
                                            ...
                                            <select class="form-select" name="order_id">
                                                <option value="{{$pages->order_id}}"> {{$pages->order_id}} </option>
                                                {{--                                               @foreach ($orders as $order)--}}
                                                {{--                                                      <option value="{{$order->id}}"> {{$order->name}} </option>--}}
                                                {{--                                                @endforeach--}}
                                            </select>
