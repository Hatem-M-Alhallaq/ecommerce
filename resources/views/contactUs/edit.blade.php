                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-10">
                                    <textarea rows="3" name="description" id="description" cols="3" class="form-control"
                                        value="{{$store->description}}"></textarea>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-form-label col-lg-2" for="shipping_policy">shipping policy:</label>
                                <div class="col-lg-10">
                                    <input type="text" name="shipping_policy" id="shipping_policy" class="form-control" value="{{$store->shipping_policy}}">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-form-label col-lg-2" for="return_privacy">return_privacy:</label>
                                <div class="col-lg-10">
                                    <input type="text" name="return_privacy" id="return_privacy" class="form-control" value="{{$store->return_privacy}}">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-form-label col-lg-2" for="keyword">keyword:</label>
                                <div class="col-lg-10">
                                    <input type="text" name="keyword" id="keyword" class="form-control" value="{{$store->keyword}}">
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-lg-10">
                                    <textarea rows="3" name="meta_description" id="meta_description" cols="3"
                                        class="form-control" value="{{$store->meta_description}}" ></textarea>
                                </div>
                            </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="form-group row">
                                ...
                                <div class="col-lg-10">
                                    <input type="text" name="tax_number" id="tax_number" class="form-control" value="{{$store->tax_number}}">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-form-label col-lg-3" for="mapLngLat">mapLngLat</label>
                                <div class="col-lg-9">
                                    <input type="text" name="mapLngLat" id="mapLngLat" class="form-control"
                                        value="{{$store->mapLngLat}}">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-form-label col-lg-2" for="logo">logo</label>
                                <div class="col-lg-10">
                                    <input type="file" name="logo" id="logo" class="form-control h-auto" value="{{$store->logo}}">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-form-label col-lg-2" for="banner">banner</label>
                                <div class="col-lg-10">
                                    <input type="file" name="banner" id="banner" class="form-control h-auto" value="{{$store->banner}}">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-form-label col-lg-2" for="about_us">about us:</label>
                                <div class="col-lg-10">
                                    <input type="text" name="about_us" id="about_us" class="form-control" value="{{$store->about_us}}">
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-lg-10">
                                    <input type="text" name="shipping_charges" id="shipping_charges"
                                        class="form-control" value="{{$store->shipping_charges}}">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-form-label col-lg-2" for="category">category:</label>
                                <div class="col-lg-10">
                                    <input type="text" name="category" id="category" class="form-control" value="{{$store->category}}">
                                </div>
                            </div>
                            {{-- <div class="card-body">
