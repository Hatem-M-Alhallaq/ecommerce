...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <!-- Content area -->
        <div class="content">
            <form method="POST" action="{{route('orderItem.update', $orderItem->id)}}" enctype="multipart/form-data">
            @csrf
            @method('PUT')
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        <select class="form-select" name="id">
                                            <option value="{{$orderItem->id}}"></option>
                                ...
                                <div class="form-group row">
                                    <label class="col-form-label col-lg-2" for="price">Price</label>
                                    <div class="col-lg-10">
                                        <input type="text" name="price" id="price" value="{{$orderItem->price}}" class="form-control">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-form-label col-lg-2" for="total">Total</label>
                                    <div class="col-lg-10">
                                        <input type="text" name="total" id="total" value="{{$orderItem->total}}" class="form-control">
                                    </div>
                                </div>
