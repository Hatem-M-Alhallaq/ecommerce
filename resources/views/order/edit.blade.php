                    ...
                    <div class="col-md-6">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-10">
                                        <input type="text" name="firstname" id="firstname" class="form-control"
                                               placeholder="Enter First Name" value="{{$order->first_name}}">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-10">
                                        <input type="text" name="lastname" id="lastname" class="form-control"
                                               placeholder="Enter last Name" value="{{$order->last_name}}">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-form-label col-lg-2" for="currency">Currency</label>
                                    <div class="col-lg-10">
                                        <input type="text" name="currency" id="currency" value="{{$order->currency}}" class="form-control h-auto">
                                    </div>
                                </div>
                                <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    <label class="col-form-label col-lg-2" for="date">Date</label>
                                    <div class="col-lg-10">
                                        <input type="text" name="date" id="date" value="{{$order->date}}" class="form-control">
                                    </div>
                                </div>
